...
export const FILMS: Film[] = [
  {
    id: 'glossary-of-an-empty-orchestra',
    title: 'GLOSSARY OF AN EMPTY ORCHESTRA (鏡花水月)',
    year: '2023',
    director: 'MIKA ŌGAI',
  ...
  {
    id: 'ways-that-i-have-died',
    title: 'WAYS THAT I HAVE DIED',
    year: '2025',
  ...
  {
    id: 'in-grandfathers-skin',
    title: 'IN GRANDFATHER’S SKIN',
    year: 'TBD',
    director: 'TBD',
    status: 'Short Documentary',
